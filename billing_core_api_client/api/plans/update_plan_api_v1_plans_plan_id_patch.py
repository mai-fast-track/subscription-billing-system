...
from ...models.subscription_plan_update import SubscriptionPlanUpdate
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        plan_id (int):
        body (SubscriptionPlanUpdate): Схема для обновления плана подписки
