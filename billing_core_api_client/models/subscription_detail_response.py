...
T = TypeVar("T", bound="SubscriptionDetailResponse")
...
class SubscriptionDetailResponse:
    ...
    Attributes:
        ...
        plan (SubscriptionPlanResponse): Схема плана подписки для ответа
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        plan = SubscriptionPlanResponse.from_dict(d.pop("plan"))
        ...
        subscription_detail_response = cls(
            plan_id=plan_id,
            start_date=start_date,
            end_date=end_date,
            id=id,
        ...
        subscription_detail_response.additional_properties = d
        return subscription_detail_response
