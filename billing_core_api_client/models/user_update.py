...
class UserUpdate:
    ...
    Attributes:
        username (Union[None, Unset, str]): Имя пользователя
        first_name (Union[None, Unset, str]): Имя
        last_name (Union[None, Unset, str]): Фамилия
        is_active (Union[None, Unset, bool]): Активен ли пользователь
    """
