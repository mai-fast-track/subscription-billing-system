...
T = TypeVar("T", bound="PromotionCreate")
...
class PromotionCreate:
    ...
    Attributes:
        ...
        assigned_user_id (Union[None, Unset, int]): ID пользователя, которому назначен промокод (None = общий промокод)
    """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        promotion_create.additional_properties = d
